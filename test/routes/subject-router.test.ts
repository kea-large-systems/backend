...
describe("test subject router", () => {
  ...
  describe("get /:subjectId", () => {
    test("Id that exists in database", async () => {
      ...
      expect(response.body).toStrictEqual({ name: "Testing", subjectId: 1, classId: 1, teacherUserId: 1 });
    });
  ...
  describe("get by-teacher/:teacherId", ()=> {
    test("receives subjects by teacher id",async ()=> {
      ...
      expect(response.body).toStrictEqual([
        { subjectId: 1, name: 'Testing', teacherUserId: 1, classId: "SW20" },
        { subjectId: 2, name: 'Testing', teacherUserId: 1, classId: "SW21" },
        { subjectId: 3, name: 'Testing', teacherUserId: 1, classId: "SW22" }
      ])
    })
...
const expectedAllSubjects = [
  { subjectId: 1, name: "Testing", teacherUserId: 1, classId: 1 },
  { subjectId: 2, name: "Testing", teacherUserId: 1, classId: 3 },
  { subjectId: 3, name: "Testing", teacherUserId: 1, classId: 5 },
  { subjectId: 4, name: "Web Development", teacherUserId: 2, classId: 2 },
  { subjectId: 5, name: "Web Development", teacherUserId: 2, classId: 4 },
  { subjectId: 6, name: "Web Development", teacherUserId: 2, classId: 6 },
  { subjectId: 7, name: "Databases", teacherUserId: 3, classId: 1 },
  { subjectId: 8, name: "Databases", teacherUserId: 3, classId: 3 },
  { subjectId: 9, name: "Databases", teacherUserId: 3, classId: 5 },
  { subjectId: 10, name: "Large Systems", teacherUserId: 4, classId: 1 },
  { subjectId: 11, name: "Large Systems", teacherUserId: 4, classId: 3 },
  { subjectId: 12, name: "Large Systems", teacherUserId: 4, classId: 5 },
];